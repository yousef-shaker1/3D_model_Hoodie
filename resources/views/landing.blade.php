...
<head>
    ...
    <meta name="description" content="stylak — صمّم تيشيرتك بنفسك بتقنية 3D. اختر اللون، أضف لوجوك، واطلب بسهولة.">
    <title>stylak — صمّم تيشيرتك بنفسك</title>
...
<nav class="nav" id="navbar">
    <a href="#" class="nav-logo">Sty<em>l</em>ak</a>
...
<section class="hero">
    ...
    <div class="hero-inner">
        ...
        <div class="hero-img-wrap reveal reveal-delay-2">
            <img src="{{ asset('assets/img/scrin.png') }}" alt="واجهة مصمم stylak" class="hero-img">
        </div>
    </div>
</section>
...
<section class="features" id="features">
    <div class="section-wrap">
        <div class="features-header">
            <span class="section-tag reveal">لماذا stylak؟</span>
...
<section class="cta-section">
    <div class="cta-card reveal">
        <h2>جاهز تبدأ؟</h2>
        <p>انضم لآلاف العملاء اللي صمّموا تيشيرتهم الخاص مع stylak</p>
    ...
    <div class="section-wrap">
        <div class="contact-text">
            ...
            <div class="social-row reveal reveal-delay-3">
                ...
                <a href="https://instagram.com/stylak" target="_blank" class="social-pill">
                ...
                <a href="https://facebook.com/stylak" target="_blank" class="social-pill">
...
<footer class="footer">
    ...
    <p>© 2024 stylak. جميع الحقوق محفوظة</p>
